...
import { fetchWatti } from "@/app/(protected)/services/wattiTemplate/api";

// Dynamic imports
const ExampleTwo = dynamic(() => import("../../../templateTable"), {
  ssr: false,
});
