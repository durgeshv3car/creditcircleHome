...
export async function GET() {
  try {
    ...
    const res = await fetch(`${BASE_URL}/getAllEmailTemplate`, {
      headers: {
        Authorization: token || "",
      },
    });
...
export async function POST(req: NextRequest) {
  try {
    ...
    const res = await fetch(`${BASE_URL}/createEmailTemplate`, {
      method: "POST",
      headers: {
...
export async function PUT(req: NextRequest) {
  try {
    ...
    const body = await req.json();
    const res = await fetch(`${BASE_URL}/updateEmailTemplatename/${id}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
        Authorization: token || "",
...
export async function DELETE(req: NextRequest) {
  try {
    ...
    const res = await fetch(`${BASE_URL}/deleteEmailTemplatename/${id}`, {
      method: "DELETE",
      headers: {
        Authorization: token || "",
      },
