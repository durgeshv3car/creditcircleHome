...
export function HeaderDateRangeToolsAna() {
  ...
  React.useEffect(() => {
    const startDate = localStorage.getItem("startDateToolsAna");
    const endDate = localStorage.getItem("endDateToolsAna");
  ...
  const handleDateRangeChange = (range: DateRange | undefined) => {
    ...
    if (range?.from && range?.to) {
      ...
      localStorage.setItem("startDateToolsAna", formatDate(range.from));
      localStorage.setItem("endDateToolsAna", formatDate(range.to));
  ...
  const handleReset = () => {
    localStorage.removeItem("startDateToolsAna");
    localStorage.removeItem("endDateToolsAna");
