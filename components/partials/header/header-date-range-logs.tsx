...
export function HeaderDateRangeLogs() {
  ...
  React.useEffect(() => {
    const startDate = localStorage.getItem("startDateLogs");
    const endDate = localStorage.getItem("endDateLogs");
  ...
  const handleDateRangeChange = (range: DateRange | undefined) => {
    ...
    if (range?.from && range?.to) {
      ...
      localStorage.setItem("startDateLogs", formatDate(range.from));
      localStorage.setItem("endDateLogs", formatDate(range.to));
  ...
  const handleReset = () => {
    localStorage.removeItem("startDateLogs");
    localStorage.removeItem("endDateLogs");
